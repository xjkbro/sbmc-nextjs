...
import {roboto, robotoSlab} from '../components/font'
    ...
    <>
        <div className="h-[80vh] bg-fixed bg-center bg-cover homescreen-parallax">
            <div className="h-[75vh] flex flex-col justify-center items-center">
                <div className={"font-bold text-[48px] text-yellow-300 " + robotoSlab.className}>MATH FOR THE FUTURE</div>
        ...
        <div className="flex justify-center gap-8">
            <Link
                ...
                <span className={"drop-shadow uppercase text-[26px] font-bold text-center " + robotoSlab.className}>Math <br />Tournament</span>
                <FontAwesomeIcon
                    className="py-1"
                    icon={faTrophy}
            ...
            <Link
                ...
                <span className={"drop-shadow uppercase text-[26px] font-bold " + robotoSlab.className}>Register</span>
                <FontAwesomeIcon
                    className="py-1"
                    icon={faPenToSquare}
                    style={{ fontSize: 72, color: "white" }}
            ...
            <Link
                ...
                <span className={"drop-shadow uppercase text-[26px] font-bold " + robotoSlab.className}>Contact</span>
                <FontAwesomeIcon
                    className="py-1"
                    icon={faEnvelope}
                    style={{ fontSize: 72, color: "white" }}
        ...
        <div className="flex flex-col justify-center my-24">
            <div className="flex flex-col justify-center text-center">
                ...
                <div className={"text-teal-600 uppercase text-[42px] font-bold " + robotoSlab.className}>South Bay Math Circle</div>
            </div>
